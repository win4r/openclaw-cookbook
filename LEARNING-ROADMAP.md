...
### Beginner Path — Personal AI (2 hours)
...
| 2 | 02-channels (pick one) | 30 min | Bot on Telegram, Discord, Slack, WhatsApp, Twitch, or iMessage |
...
| 5 | 13-control-ui | 15 min | Web dashboard to manage everything |

**Total: ~2 hours.** Skip 03 if you are fine with the default model. Skip 13 if you prefer CLI only.

### Builder Path — Multi-Agent System (5 hours)
...
| 5 | 04-multi-agent | 45 min | Agents, bindings, routing + ClawTeam swarm |
| 6 | 05-memory | 30 min | LanceDB long-term memory |
| 7 | 06-tools | 40 min | Custom tools, exec, MCP integration |
| 8 | 11-scheduler | 25 min | Cron jobs, reminders, heartbeat |
| 9 | 13-control-ui | 15 min | Web dashboard |
| 10 | 10-recipes (pick one) | 30 min | End-to-end working scenario |

**Total: ~5 hours.** You can stop after step 5 if you don't need memory or tools yet.

### Production Path — Team/Company Deployment (8+ hours)

You need security, monitoring, cost controls, and reliability. Everything from Builder, plus hardening and ops.

| Order | Module | Time | What you get |
|-------|--------|------|--------------|
| 1-9 | All Builder modules | 4.5 hrs | Full multi-agent system |
| 10 | 07-security | 30 min | SOUL.md hardening, auth, exec allowlists |
| 11 | 09-production | 45 min | Monitoring, logging, cost control |
| 12 | 12-nodes | 30 min | iOS, Android & macOS device integration |
| 13 | 02-channels (remaining) | 30-60 min | All channels your team needs |
| 14 | 10-recipes (2-3 recipes) | 60-90 min | Battle-tested patterns |

**Total: ~8+ hours.** Module 07 (security) should be done before any external users touch the system.
...
graph TD
    ...
    M11["11-scheduler<br/>25 min"]
    M12["12-nodes<br/>30 min"]
    M13["13-control-ui<br/>15 min"]
    ...
    style M11 fill:#2d3436,stroke:#0984e3,color:#dfe6e9
    style M12 fill:#2d3436,stroke:#0984e3,color:#dfe6e9
    style M13 fill:#2d3436,stroke:#0984e3,color:#dfe6e9
```
...
- **11-scheduler**, **12-nodes**, and **13-control-ui** (blue) only depend on 01 -- you can explore them at any point.
...
| 11-scheduler (25 min) | Skip | Required (25 min) | Required (25 min) |
| 12-nodes (30 min) | Skip | Skip | Required (30 min) |
| 13-control-ui (15 min) | Optional (15 min) | Required (15 min) | Required (15 min) |
| **Total** | **~2 hrs** | **~5 hrs** | **~8+ hrs** |
