...
| **02** | [渠道接入](./02-channels/) | Telegram 机器人、Discord、Slack、WhatsApp | 每个 30 分钟 |
| **03** | [模型供应商](./03-model-providers/) | 多模型配置 + 降级链 + 路由策略 | 20 分钟 |
| **04** | [多智能体](./04-multi-agent/) | 专业化智能体 + ClawTeam 蜂群协调 | 45 分钟 |
...
**全部掌握约需 6 小时。** 或者直接跳到[实战配方](#实战配方)，边做边学。
...
| 配方 | 描述 | 使用模型 | 渠道 |
|------|------|---------|------|
| [Telegram 个人 AI](./10-recipes/personal-ai-on-telegram/) | 带记忆、搜索、个性化的私人 AI 助手 | 任意 | Telegram |
| [客户支持机器人](./10-recipes/customer-support-bot/) | 多语言客服 + 升级规则 + 知识库 | Claude + 降级 | Telegram, Web |
| [代码审查团队](./10-recipes/code-review-team/) | ClawTeam 蜂群从多角度审查 PR | Claude + GPT | GitHub + Slack |
| [研究助手](./10-recipes/research-assistant/) | 自动研究、汇总、通过聊天推送结论 | GPT + Gemini | Telegram, Discord |
...
- **一个 API Key**（Anthropic、OpenAI、MiniMax 等任一供应商）
- **5 分钟**开始体验，或约 6 小时完成全部内容
